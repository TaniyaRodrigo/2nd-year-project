...
<body id="page-top">
        ...
        <div class="container"><a class="navbar-brand" href="#page-top">FaceID</a><button class="navbar-toggler navbar-toggler-right" data-toggle="collapse" data-target="#navbarResponsive" type="button" data-toogle="collapse" aria-controls="navbarResponsive" aria-expanded="false"
            ...
            <div class="collapse navbar-collapse" style="position: fixed; margin-left: 450px;" id="navbarResponsive">
                <ul class="nav navbar-nav ml-auto text-uppercase">
                    ...
                    <li class="nav-item" role="presentation"><a class="nav-link js-scroll-trigger" href="">Logout</a></li>
                </ul>
            </div>
        </div>
    </nav>
    ...
    <div class="d-flex justify-content-center" style="padding:60px">
        ...
        <thead>
            <tr>
                <th style="padding:10px; text-align:center">Requested JMO</th>
        ...
        <?php while ($row = mysqli_fetch_array($results)) { ?>
            ...
            <tr>
                <td style="padding:10px;padding-left:30px;padding-right:30px; text-align:center"><?php echo $row['jmo'];?></td>
                ...
                <td style="padding:10px;padding-left:30px;padding-right:30px; text-align:center"><button class="btn btn-secondary" type="submit">View Details </button></td>
                </form>
