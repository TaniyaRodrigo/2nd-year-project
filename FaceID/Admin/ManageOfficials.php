...
<body id="page-top">
    ...
    <h2 style="color:black; text-align: center; padding-top: 10%;">Model Creators</h2>
        ...
        <?php while ($row = mysqli_fetch_array($results)) { ?>
            <form method="post" action="./EditProfiles.php">
                <tr>
                    ...
                    <form method="post" action="ManageOfficials.php">
                        <input type="hidden" name="nic" id="nic" value="<?php echo $row['NIC']; ?>" />
                        <td style="padding:10px; text-align:center"><button type="submit" onclick="myFunction()" name="delete_btn" class="btn btn-secondary" >Delete</button></td>
                    </form>
                </tr>
            </form>
        <?php } ?>
