    ...
    <form method="post" action = "./ManageOfficials.php">
        ...
        <tr>
            ...
            <tr>
                ...
                <td style=" text-align:center"> <input type="text" class="rounded"  style="height:40px;width:95%;border:none;border:1px solid white;background-color:transparent;color:white;" name="contact" pattern="[0-9]{10}"value="<?php echo $contact;?>" size="60" ></td>
            </tr>
            <tr>
