        ...
        <div class="d-flex justify-content-center form-group" style="padding:60px">
            <table class="table-dark table-striped" style="border:1px solid black;margin-left:auto;margin-right:auto;">
                <tr>
                    ...
                    <td style="text-align:center;padding:10px"  width="600px"> 
                ...
                <tr>
                    ...
                    <td style="text-align:center"  width="600px"> <button onclick="Add()" class="btn btn-secondary" name="AddArti" formmethod="post" type="submit">Submit</td>
                </tr>
            </table>
        </div>    
    </form>
