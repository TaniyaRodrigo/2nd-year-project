    ...
    <div class="" >
        ...
        <?php while ($row = mysqli_fetch_array($results)) { 
            ...
            <tr> 
                 ...
                 <td style="padding:10px; text-align:center"><?php echo "<img src ='data:image/jpg;base64,".base64_encode($picture)."'alt = ''/ width=300px height=300px>"; ?></td>
             </tr> 
             <tr>
                <th style="padding:20px; text-align:center" width="200px">Subject</th>
                <td style="text-align:center"> <input type="text" styleclass="rounded"  style="height:40px;width:98%;border:none;border:1px solid white;background-color:transparent;color:white;" name="subject" placeholder=" Subject" size="60" ></td>
             </tr>
             <tr>
                <th style="padding:20px; text-align:center" width="200px">Reply</th>
                <td style="text-align:center"> <input type="text" styleclass="rounded"  style="height:40px;width:98%;border:none;border:1px solid white;background-color:transparent;color:white;" name="msg" placeholder=" Write your reply here" size="60" ></td>
             </tr> 
