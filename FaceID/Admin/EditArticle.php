...
<body id="page-top">
    ...
    <h2 style="color:black; text-align: center; padding-top: 10%;">Edit Article</h2>
    <form method="post" action = "ViewArticle.php">
        <div class="d-flex justify-content-center form-group" style="padding:60px">
            ...
            <table class="table-dark table-striped" style="border:1px solid black;margin-left:auto;margin-right:auto;">
                <tr>
                    <th style="padding:20px;text-align:center" width="200px">ID</th>
                    <td style="text-align:center"  width="600px"> <?php echo $row['id'];?><td>
                </tr>
                <tr>
                    <th style="padding:20px;text-align:center" width="200px">Date</th>
                    <td style="text-align:center"  width="600px"> <?php echo $row['date'];?><td>
                </tr>
                <tr>
                    <th style="padding:20px;text-align:center" width="200px">Article</th>
                    <td style="text-align:center"  width="600px"> <textarea rows="10" class="rounded"  style="width:95%;border:none;border:1px solid white;background-color:transparent;color:white;" name="article" size="500" value="<?php echo $row['article'];?>"><?php echo $row['article'];?></textarea></td>
                </tr>
                <tr>
                    <th style="padding:20px;text-align:center" width="200px"></th>
                    <input type="hidden" name="id" id="id" value="<?php echo $row['id']; ?>">
                    <td style="text-align:center"  width="600px"> <button onclick="myFunction()" class="btn btn-secondary" name="editArti" formmethod="post" type="submit">Update</td>
                </tr>
            </table>
        </div>    
    </form>
